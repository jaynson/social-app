...
namespace API.Controllers
{
    ...
    **/
    ...
    public class UsersController : BaseApiControlller
    {
        ...
        // Method that allows change to persist to the User Entity in the API
        ...
        public async Task<ActionResult> SetMainPhoto(int photoId)
        {
            ...
            if(photo.IsMain) return BadRequest("Same main photo yo!");
            ...
            return BadRequest("Bummer. Something daft happened");
        }
